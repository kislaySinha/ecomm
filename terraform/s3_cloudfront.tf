...
resource "aws_cloudfront_distribution" "frontend" {
  ...
  comment             = "${var.project} React frontend"
  ...
  # API paths → ALB (no caching, forward everything)
  dynamic "ordered_cache_behavior" {
    for_each = toset(["/auth/*", "/products/*", "/admin/*", "/search/*", "/cart/*", "/orders/*", "/wishlist/*", "/reviews/*", "/payment/*"])
    content {
  ...
  # Return index.html for all 404/403 so React Router works
